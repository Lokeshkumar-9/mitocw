...
def hangman():
    ...
    while True:
        ...
        if remaining_guesses == 0:
            print("\nSorry, you're out of guesses. The word was:", secret_word)
            break
...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    print("Welcome to Hangman!")
    print(f"The word contains {len(secret_word)} letters.")
    
    while True:
      print("\nCurrent Word:", get_guessed_word(secret_word, guessed_letters))
      print("Remaining Guesses:", remaining_guesses)
      ...
      if guess in secret_word:
        ...
        if get_guessed_word(secret_word, guessed_letters) == secret_word:
          ...
          break
        if remaining_guesses == 0:
          print("\nSorry, you are out of guesses. The word was:", secret_word)
          break
...
def show_possible_matches(my_word):
    ...
    if matching_words:
        ...
        print("No matches found for the current guess.")
...
def hangman_with_hints(secret_word):
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    while True:
        ...
        if guess == '*':
            # Allow the user to see possible matches
            show_possible_matches(get_guessed_word(secret_word, guessed_letters))
            continue
